...
const ArticleList = () => {
  return (
    <div className="mb-20">
      <h1 className="sm:text-4xl text-center text-2xl font-bold mt-6 mb-6 text-gray-600">ArticleList</h1>
              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  <Link key={index} to={`/article/${article.name}`}>
                    ...
                    <p className="reading-relaxed mb-3">{article.content[0].substring(0, 115)}...</p>
